...
from tkinter import *
from tkinter import ttk  # bg,fg dosent work, look up ttk colors
from appett.sqlScripts import sqlConnector, createDatabase, dropDatabase, insertQuery, showDb
from appett.socketScrips import socket_connect, server
...
class Appgui(Tk):
    def __init__(self, *args, **kwargs):
        ...
        Tk.iconbitmap(self, default="Untitled.ico")
