...
from cv2showImgVideo import fpsShow, showimage
...
miscmenu.add_command(label="Programming 5", command='')
...
playA = Radiobutton(root, text='Play A', value=1, command=a)
playA.grid(column=4, row=2)
playD = Radiobutton(root, text='Play D', value=1, command=d)
playD.grid(column=4, row=3)
playG = Radiobutton(root, text='Play G', value=1, command=g)
playG.grid(column=4, row=5)
playB = Radiobutton(root, text='Play B', value=1, command=b)
